...
public class EntityGeneratorClient  {
    ...
    //模板路径
    private static String templatesPath = "D:\\IDEA\\generator-code\\src\\main\\resources\\freemarkerTemplates";

    //文件输出基本路径
    private static String basePath = "D:\\AutoCode\\"+System.currentTimeMillis();
     ...
     * 根据表名和包名生成代码主入口
     * */
    public static void generateCode(String dataBase,String username,String password,String pack,String tableName,String projectName,String applicationName){
        if ( "null".equals(pack)){
            pack = "";
        }
    	...
    	try {  
            // 获取数据库表结构数据
            TableProperty tableProperty = readData(dataBase, username, password, tableName);
...
//                          "xml.ftl","add.ftl","edit.ftl","detail.ftl","list.ftl"};
     ...
     * @return 
     */  
    public static TableProperty readData(String dataBase, String username, String password, String tableName){
        ...
        try {  
            ...
            conn = DriverManager.getConnection("jdbc:mysql://192.168.0.200:3306/"+dataBase+"?useUnicode=true&characterEncoding=utf-8",props);
