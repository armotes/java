...
<#if  pack == "">
<mapper namespace="com.pw.org.mapper.${class?cap_first}Mapper">
<#else >
<mapper namespace="com.pw.org.mapper.${pack}.${class?cap_first}Mapper">
</#if>
	<!--插入数据-->
     <#if  pack == "">
     <insert id="insertData" parameterType="com.pw.org.entity.${class}DO">
     <#else >
     <insert id="insertData" parameterType="com.pw.org.entity.${pack}.${class}DO">
     </#if>
	...
	<!--修改数据-->
     <#if  pack == "">
     <update id="updateData" parameterType="com.pw.org.entity.${class}DO">
	 <#else >
     <update id="updateData" parameterType="com.pw.org.entity.${pack}.${class}DO">
     </#if>
		<!--属性为id时不set-->
    ...
    <!--查询一条数据-->
     <#if  pack == "">
     <select id="getById" resultType = "com.pw.org.entity.${class}DO"
     <#else >
     <select id="getById" resultType = "com.pw.org.entity.${pack}.${class}DO"
    </#if>
	...
	<#list properties as property>
	 ...
	 <select id="getList"
             <#if  pack == "">
             resultType = "com.pw.org.entity.${class}DO"
             parameterType = "com.pw.common.pojo.query.${projectName}.${class}Query"

             <#else >
             resultType = "com.pw.org.entity.${pack}.${class}DO"
             parameterType = "com.pw.org.query.${pack}.${class}Query"
             </#if>
		 >
         <include refid="baseSql_${class}" ></include>
    ...
    <select id="getPageList"
        ...
        <include refid="baseSql_${class}" ></include>
        <include refid="sqlWhere_${class}" ></include>
		LIMIT <@mapperEl "pageable.offset"/>,<@mapperEl "pageable.pageSize"/>
    </select>
